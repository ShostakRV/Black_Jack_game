...
public class GameServiceMockTest {
    ...
    public void testGameCreation() {
        ...
        verify(gameConverter).convert(savedGame, GameResultUtils.sumCardPoints(), gameResult.getCroupierPoints());
    }
    ...
    public void testGameStep() {
        ...
        assertEquals(userCard1, gameCards.get(0));
        verify(gameRepository).saveAndFlush(game);
        verify(gameConverter).convert(savedGame, gameResult.getUserPoints(), gameResult.getCroupierPoints());
    }
